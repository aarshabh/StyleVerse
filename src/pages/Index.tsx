  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await requestService.getRequests({ status: "Accepted" })
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-fade-in">
              ...
              <p className="text-xl text-gray-700 max-w-lg">
                Connect with talented designers worldwide to create unique, personalized fashion items that reflect your
                style and vision.
              </p>
        ...
        <div className="container mx-auto px-4 max-w-screen-xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 mt-2 max-w-lg mx-auto">
              Our simple process connects you with talented designers to bring your fashion ideas to life.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              ...
              >
                <div className="mb-4 bg-fashion-purple/10 p-4 rounded-full inline-block">{step.icon}</div>
                <h3 className="text-xl font-semibold mb-2">{step.title}</h3>
                <p className="text-gray-600">{step.description}</p>
                <div className="mt-4 flex items-center text-fashion-purple">
                  <span className="font-bold text-2xl">{index + 1}</span>
                  {index < steps.length - 1 && <ArrowRight className="ml-2 h-5 w-5" />}
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-gradient-to-b from-white to-gray-50">
        <div className="container mx-auto px-4 max-w-screen-xl">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mt-2 max-w-lg mx-auto">
              Browse through the latest fashion requests from our community and find your next design challenge.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-screen-xl">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mt-2 max-w-lg mx-auto">
              Our platform connects you with skilled designers from around the world.
            </p>
          </div>
            ...
            <div className="md:grid md:grid-cols-5">
              <div className="md:col-span-3 p-12">
                ...
                <p className="text-xl mb-8 text-white/90 max-w-lg">
                  Join StyleVerse today and connect with talented designers around the world to create the perfect
                  custom fashion piece.
                </p>
                <Link to="/auth">
                  <Button
                    size="lg"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link to="/new-request" className="text-gray-300 hover:text-white transition-colors">
                    Create Request
                  </Link>
                </li>
              </ul>

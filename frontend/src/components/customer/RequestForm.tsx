...
const materialOptions = [
  "Cotton", "Silk", "Linen", "Polyester", "Wool", "Denim", "Leather", "Velvet", "Satin"
];
...
const RequestForm = ({ onSubmit }: RequestFormProps) => {
  ...
  const handleImageChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (event.target.files) {
      ...
      console.log('here, req form', newImageUrls);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log(title, description, material, timeframe, imagePreviewUrls);
